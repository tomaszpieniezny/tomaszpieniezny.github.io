$(document).ready(function() {
  const apiRoot = 'https://mysterious-forest-36388.herokuapp.com/v1/task//v1/task/';
  const trelloApiRoot = 'https://mysterious-forest-36388.herokuapp.com/v1/task/v1/trello/';
